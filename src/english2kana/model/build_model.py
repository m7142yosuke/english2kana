...
def build_model(
    ...
    Args:
        num_chars_name (int): Size of the input character dictionary (English).
        ...
        max_len_name (int): Maximum sequence length on the input side.
    ...
    # encoder
    encoder_inputs = Input(shape=(max_len_name,), name="encoder_input")
    enc_emb = Embedding(
        input_dim=num_chars_name,
